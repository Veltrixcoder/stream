    ...
    <div className="legal-page fade-up">
      ...
      <section className="legal-section">
        ...
        <div className="section-content glass">
          <p>Luxa is designed to be as private as possible. We do not require account registration, and we do not collect personal information such as your name, email address, or phone number.</p>
      ...
      <section className="legal-section">
        ...
        <div className="section-content glass">
          <p>Luxa connects to third-party streaming providers and TMDB for metadata. These services may collect their own data (such as IP addresses) when you request content through the app. We recommend reviewing the privacy policies of any third-party providers you configure.</p>
        </div>
      </section>
