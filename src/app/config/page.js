  ...
  return (
    <div className="config-page fade-up">
      <div className="page-header">
        ...
        <div className="app-id">
          <div className="app-id-logo">
            <img src="/icon.png" alt="Luxa Logo" />
          </div>
          <div>
            <h1 className="app-id-name">LUXA<em>.</em></h1>
      ...
      <div className="note-box glass">
        ...
        <span>All sources connect to the same backend instance. Tap <strong>Connect</strong> and Luxa will open automatically to apply the configuration.</span>
      </div>
      ...
      <div className="footer-cta">
        <p>Don't have Luxa installed yet?</p>
