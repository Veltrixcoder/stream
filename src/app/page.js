    ...
    <div className="home-page fade-up">
      <header className="home-header">
        <div className="header-top">
          <h1 className="text-gradient">Home</h1>
        </div>
      </header>
                ...
                <div className="hero-card apple-card">
                  ...
                  <div className="hero-overlay">
                    ...
                    <div className="hero-actions">
                      <Link href={`/watch?type=movie&id=${heroMovie.id}`} className="apple-btn apple-btn-primary">
                        <Play size={18} fill="currentColor" /> Play Now
                      </Link>
                      <Link href={`/details?type=movie&id=${heroMovie.id}`} className="apple-btn apple-btn-secondary">
